...
const ProjectItem = ({title, backgroundImg, projectUrl}) => {
    return (
        <div className='rounded-xl relative flex items-center justify-center h-auto w-full shadow-2xl p-4 group hover:bg-gradient-to-r from-gray-700 to-pink-100'>
